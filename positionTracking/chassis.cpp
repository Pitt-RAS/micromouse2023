...
class Chassis{
    ...
    /*
    Fake motor instance varibles assuming they are classes
    replace with real motor implementation
    ...
    */
    ...
    void updatePosition(float leftEncDelta, float rightEncDelta, float orientation) {
        ...
        //if this line causes an error switch compiler to use c++20
        double tickToMM = std::numbers::pi * wheelDiameter / encRatio; 
